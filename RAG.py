...
# txt 文件夹路径（修改为你的实际路径）
TXT_FOLDER = r"D:\hzh\py_work\llm_nlp\data\THUCNews\THUCNews\体育"
# 本地模型 Qwen9-8B-Instruct 路径（你之前下载到 pub 的）
LOCAL_MODEL_PATH = r"./model"
# 嵌入模型"BAAI/bge-m3"（支持更长文本）
EMBEDDING_MODEL = "BAAI/bge-m3"
# 向量库持久化目录
VECTOR_DB_PATH = r"./chroma_db"
...
def initialize_rag_system():
    ...
    # 7. Prompt 模板
    template = """
    你是一个体育领域内的专家。请根据以下检索到的上下文，准确、详尽地回答用户问题。
...
# 用户输入
if prompt := st.chat_input("请输入你想知道的体育领域问题"):
